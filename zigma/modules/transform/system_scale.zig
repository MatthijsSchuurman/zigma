...
pub const System = struct {
  world: *ecs.World,
  start_scales: std.AutoHashMap(ecs.EntityID, Module.Components.Scale.Component),
  ...
  pub fn init(world: *ecs.World) System {
    ...
    self.start_scales = std.AutoHashMap(ecs.EntityID, Module.Components.Scale.Component).init(world.allocator);
    return self;
  }
