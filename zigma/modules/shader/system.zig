...
const ModuleLight = @import("../light/module.zig");
...
test "System should update shader" {
  ...
  var system_light= ModuleLight.Systems.Light.System.init(&world);
  var system_model = ModuleModel.System.Model.System.init(&world);
